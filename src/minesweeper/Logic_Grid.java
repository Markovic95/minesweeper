...
public final class Logic_Grid {
	...
	public void set_reset() {
		 ...
		 * re-calculating the index lost, thus game's logic is violated, in addition to the limit() call, that further clusters the random indexes into a specific region of random numbers
		 */
		 generateMines();
